...
parser.add_argument("--network", default="sresnet", choices=["unet", "hourglass", "resnet", "srresnet"], type=str, dest="network")
...
if mode == 'train':
    ...
    transform_val = transforms.Compose([RandomCrop(shape=(ny, nx)), Normalization(mean=0.5, std=0.5), RandomFlip()])
